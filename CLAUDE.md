# CLAUDE.md — Frontend Website Rules (Mac)
...
## Screenshot Workflow
- Puppeteer is installed locally in the project (`node_modules/puppeteer`). If not present, run `npm install puppeteer` once.
...
- Name the screenshots in a human readable way
